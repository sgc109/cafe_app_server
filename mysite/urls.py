...
urlpatterns = [
    ...
    url(r'^get_waiting_order/', cafe.views.get_waiting_order, name = 'get_waiting_order'),
    ...
    url(r'^change_order_state/', cafe.views.change_order_state, name = 'change_order_state'),
    url(r'^test_fcm/', cafe.views.test_fcm, name = 'test_fcm'),
